...
def hit_stand():
    ...
    if choice == "hit" or choice == "stand":
        ...
        while not (choice == "hit" or choice == "stand"):
            choice = input(
                "You entered something other than Hit or Stand! Please try again!: ")
            choice = choice.lower()
...
print("Player hand: " + str(player_hand) +
      " Player Total: " + str(card_value(player_hand)))

dealer_hand = [d.deal_card()]
print("Dealer hand: " + str(dealer_hand) +
      " Dealer Total: " + str(card_value(dealer_hand)))
print("\n")
